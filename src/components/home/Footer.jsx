    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Making university campuses safer through real-time incident reporting and community awareness.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Email: support@campussafety.com</li>
              <li>Emergency: 911</li>
              <li>Campus Security: Contact your campus</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Campus Safety. All rights reserved.</p>
